  ...
  return (
    <div className="w-full min-h-screen bg-background overflow-x-hidden pt-12 md:pt-16">
      ...
      <div className="w-full max-w-7xl flex flex-1 flex-col  mx-auto py-24 px-8 gap-12">
        <Title content="Verificação de assinatura" className="text-center" />
        <Phrase content="Informe seu e-mail abaixo para verificar sua assinatura. Caso exista uma assinatura válida vinculada ao seu email o download estará disponível." />
